...
def extract_feature_emotion_X_y_array(filter=True):
    ...
    if 'MFCC' in para.features:
        ...
        feature_emotion_X_Y_array = MFCC.extract_feature_emotion_X_y_array(filter)
    ...
    if 'SSC' in para.features:
        ...
        feature_emotion_X_Y_array = SSC.extract_feature_emotion_X_y_array(filter)
        X = feature_emotion_X_Y_array['X']
        y = feature_emotion_X_Y_array['y']
        result.append(X)
    ...
    if 'Chroma' in para.features:
        ...
        feature_emotion_X_Y_array = Chroma.extract_feature_emotion_X_y_array(filter)
        X = feature_emotion_X_Y_array['X']
        y = feature_emotion_X_Y_array['y']
        result.append(X)
    if 'MelSpectrogram' in para.features:
        ...
        feature_emotion_X_Y_array = MelSpectrogram.extract_feature_emotion_X_y_array(filter)
        X = feature_emotion_X_Y_array['X']
        y = feature_emotion_X_Y_array['y']
        result.append(X)
    ...
    #                   sample_rate=self.sample_rate, stft=self.stft).extract())
        feature_emotion_X_Y_array = Contrast.extract_feature_emotion_X_y_array(filter)
        X = feature_emotion_X_Y_array['X']
        y = feature_emotion_X_Y_array['y']
        result.append(X)
    ...
    #                   sample_rate=self.sample_rate, stft=self.stft).extract())
        feature_emotion_X_Y_array = Tonnetz.extract_feature_emotion_X_y_array(filter)
        X = feature_emotion_X_Y_array['X']
        y = feature_emotion_X_Y_array['y']
        result.append(X)
    ...
    #                   sample_rate=self.sample_rate).extract())
        feature_emotion_X_Y_array = F0.extract_feature_emotion_X_y_array(filter)
        X = feature_emotion_X_Y_array['X']
        y = feature_emotion_X_Y_array['y']
        result.append(X)
    # print(result)
